...
To reproduce this project:
 Download the dataset (source: "https://d3ilbtxij3aepc.cloudfront.net/projects/CDS-Capstone-Projects/PRCP-1001-RiceLeaf.zip" ).

The notebook itself handles unzipping and flattening nested folders if you start from the raw archive — see `PRCP-1001-RiceLeaf.zip` handling in the first few cells.
